...
public class CategoriaDAO extends AppCrud{
    ...
    public void editar(){
        lar=new LeerArchivo("Categoria.txt");
          catTO=new CategoriaTO();
          catTO.setIdCateg(tre.read("","INGRESE EL ID DE CATEGORIA"));
          catTO.setNombre(tre.read("","INGRESE EL NOMBRE DE CATEGORIA"));
          editarRegistro(lar, 0, catTO.getIdCateg(), catTO);
    }
